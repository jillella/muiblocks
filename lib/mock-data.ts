...
export const mockProductTypeVarBubbles: ProductTypeVarBubblePoint[] = [
  { product: 'Cap Floor', value: 0.12, kind: 'currentPositive' },
  { product: 'Cap Floor', value: 0.18, kind: 'prior' },

  { product: 'IR Swaption', value: 0.28, kind: 'prior' },
  { product: 'IR Swaption', value: -0.32, kind: 'currentNegative' },
  { product: 'IR Swaption', value: -0.22, kind: 'prior' },

  { product: 'IR Swap', value: 0.55, kind: 'currentPositive' },
  { product: 'IR Swap', value: 0.42, kind: 'prior' },
  { product: 'IR Swap', value: -0.62, kind: 'currentNegative' },
  { product: 'IR Swap', value: -0.48, kind: 'prior' },

  { product: 'Corporate Bonds', value: 0.38, kind: 'currentPositive' },
  { product: 'Corporate Bonds', value: 0.26, kind: 'prior' },
  { product: 'Corporate Bonds', value: -0.2, kind: 'currentNegative' },
  { product: 'Corporate Bonds', value: -0.14, kind: 'prior' },

  { product: 'Treasury Bonds', value: 0.16, kind: 'currentPositive' },
  { product: 'Treasury Bonds', value: 0.22, kind: 'prior' },
  { product: 'Treasury Bonds', value: -0.12, kind: 'currentNegative' },
  { product: 'Treasury Bonds', value: -0.18, kind: 'prior' },

  { product: 'CDS', value: 0.58, kind: 'currentPositive' },
  { product: 'CDS', value: 0.44, kind: 'prior' },
  { product: 'CDS', value: -0.36, kind: 'currentNegative' },
  { product: 'CDS', value: -0.28, kind: 'prior' },

  { product: 'TIPs', value: 0.1, kind: 'currentPositive' },
  { product: 'TIPs', value: 0.16, kind: 'prior' },
  { product: 'TIPs', value: -0.18, kind: 'currentNegative' },
  { product: 'TIPs', value: -0.12, kind: 'prior' },
];
